...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Icons": () => (/* binding */ Icons),
  "Slide": () => (/* binding */ Slide),
  "ToastContainer": () => (/* binding */ ToastContainer),
  "Zoom": () => (/* binding */ Zoom),
  "collapseToast": () => (/* binding */ collapseToast),
  "cssTransition": () => (/* binding */ cssTransition),
  "toast": () => (/* binding */ toast),
  "useToast": () => (/* binding */ useToast),
  "useToastContainer": () => (/* binding */ useToastContainer)
});
...
function Warning(props) {
  return (0,react.createElement)(Svg, Object.assign({}, props), (0,react.createElement)("path", {
...
var Toast = function Toast(props) {
  ...
  }, Icon), (0,react.createElement)("div", null, children)), renderCloseButton(closeButton), (autoClose || isProgressControlled) && (0,react.createElement)(ProgressBar, Object.assign({}, updateId && !isProgressControlled ? {
    key: "pb-" + updateId
  } : {}, {
    rtl: rtl,
    theme: theme,
...
const Header = () => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "header" },
            ...
            react_1.default.createElement(react_router_dom_1.Link, { to: '/redux' },
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MostRecentCSS = void 0;
const react_1 = __importStar(__webpack_require__(294));
const react_toastify_1 = __webpack_require__(249);
const data = __webpack_require__(714);
const MostRecentCSS = () => {
        ...
        try {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                newPre.onclick = () => {
                    ...
                    react_toastify_1.toast.success('Copied!', {
                        position: "top-left",
                        autoClose: 1500,
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "CSS-Page-Container Page-Container" },
            react_1.default.createElement("div", { className: "CSS-List-Container List-Container" },
                react_1.default.createElement("div", null),
                react_1.default.createElement("ul", { className: "CSS-Items-UL Items-UL" }),
                react_1.default.createElement("div", null)),
            react_1.default.createElement("div", { className: "CSS-Content Content" }))));
};
exports.MostRecentCSS = MostRecentCSS;
...
const react_1 = __importStar(__webpack_require__(294));
const react_toastify_1 = __webpack_require__(249);
const data = __webpack_require__(897);
const MostRecentHTML = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "HTML-Page-Container Page-Container" },
            react_1.default.createElement("div", { className: "HTML-List-Container List-Container" },
                react_1.default.createElement("div", null),
                react_1.default.createElement("ul", { className: "HTML-Items-UL Items-UL" }),
                react_1.default.createElement("div", null)),
            react_1.default.createElement("div", { className: "HTML-Content Content" }))));
};
exports.MostRecentHTML = MostRecentHTML;
...
const react_1 = __importStar(__webpack_require__(294));
const react_toastify_1 = __webpack_require__(249);
const data = __webpack_require__(211);
const MostRecentReact = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "React-Page-Container Page-Container" },
            react_1.default.createElement("div", { className: "React-List-Container List-Container" },
                react_1.default.createElement("div", null),
                react_1.default.createElement("ul", { className: "React-Items-UL Items-UL" }),
                react_1.default.createElement("div", null)),
            react_1.default.createElement("div", { className: "React-Content Content" }))));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MostRecentRedux = void 0;
const react_1 = __importDefault(__webpack_require__(294));
const MostRecentRedux = () => {
    return (react_1.default.createElement(react_1.default.Fragment, null, "23rfd"));
};
exports.MostRecentRedux = MostRecentRedux;
...
module.exports = JSON.parse('[{"title":"Initializing CSS","pre":"*{\\n\\tbox-sizing: border-box;\\n\\tborder: 0px;\\n\\tmargin: 0px;\\n}","note":"Removing all borders and marins. Defaulting Box-Sizing."},{"title":"Page Width","pre":"#root{\\n\\tmax-width: 100vw;\\n}","note":"Important to prevent x-overflow."},{"title":"Animation Properties","pre":"animation-name: none\\nanimation-duration:\\nanimation-timing-function: linear | ease-in | ease-out \\nanimation-delay:\\nanimation-iteration-count: infinite\\nanimation-direction: reverse | alternate | alternate-reverse\\nanimation-fill-mode: forwards | backwards | both\\nanimation-play-state: paused | running","note":"Animations properties and useful values."},{"title":"Clip-Path Generator","pre":"https://www.cssportal.com/css-clip-path-generator/","note":"Useful tool for easy clip-paths."},{"title":"CSS Backgrounds","pre":"https://projects.verou.me/css3patterns/","note":"A number of css gradient backgrounds."},{"title":"Design Responsiveness","pre":"@media screen and (max-width: 0px){\\n\\n}","note":"Template for responsive design."},{"title":"Remove Animations","pre":"*{\\n\\tanimation-name: none!important;\\n} ","note":"Removing animations for responsive designs."},{"title":"Toastify CSS","pre":".Toastify__toast--error{\\n\\tbackground: rgb(219, 0, 0)!important;\\n}\\n.Toastify__toast-container--top-center{\\n\\ttop: 40%!important;\\n}\\n.Toastify__close-button{\\n\\tdisplay: none!important;\\n}","note":"Overwriting Toastify default CSS"},{"title":"Loading Spinners","pre":"https://loading.io/css/","note":"Nice spinners to easily use in projects."}]');
...
module.exports = JSON.parse('[{"title":"Meta Tag","pre":"<Meta \\n\\tname=\'description\'\\n\\tcontent=\'\'>","note":"For boosting lighthouse score."},{"title":"Favicon Error","pre":"<link rel=\'shortcut icon\' href=\'#\'/>","note":"This gets rid of the console error for not having a favicon."},{"title":"Favicon Generator","pre":"https://realfavicongenerator.net/","note":"An easy way to make favicons from an image."},{"title":"CSS Stylesheet","pre":"<link rel=\'stylesheet\' href=\'\'>","note":"Linking a simple CSS stylesheet."},{"title":"Root","pre":"<div id=\'root\'></div>","note":"Standard root div."},{"title":"Bundle","pre":"<script src=\'./dist/bundle.js\'></script>","note":"Standard bundle script. I think body is better than head but not 110% certain."}]');
...
module.exports = JSON.parse('[{"title":"New React v18 index","pre":"const root = ReactDOM.createRoot(document.getElementById(\\"root\\") as HTMLElement);\\n\\nroot.render(\\n\\t<React.StrictMode>\\n\\t\\t<App />\\n\\t</React.StrictMode>\\n)","note":"The new way to do root in index.(tsx|ts|js|jsx)"},{"title":"React-Router-Dom HashRouter Way","pre":"<HashRouter>\\n\\t<Routes>\\n\\t\\t<Route path=\'/\' element={</>}/>\\n\\t\\t<Route index element={</>}/>\\n\\t\\t<Route path=\\"*\\" element={</>}/>\\n\\t</Routes>\\n</HashRouter>","note":"Webpack doesn\'t like BrowserRouter so I use this with webpack. index element means default on page load. * means a bad route."},{"title":"React-Router-Dom BrowserRouter Way","pre":"<BrowserRouter>\\n\\t<Routes>\\n\\t\\t<Route path=\'/\' element={</>}/>\\n\\t\\t<Route index element={</>}/>\\n\\t\\t<Route path=\\"*\\" element={</>}/>\\n\\t</Routes>\\n</BrowserRouter>","note":"This is the standard way without webpack."}]');
